  ...
  return (
    <div className="py-20 bg-gray-200" name="product">
      <div className="space-y-2 p-3 text-center max-w-[600px] mx-auto mb-5">
        ...
        <p className="text-3xl font-bold text-gray-900 leading-[3.25rem]">
          Built to Last: Superior Galvanized Steel & Iron Products
        </p>
      </div>
      <div id="swiper" className="flex items-center justify-center flex-col h-[400px]">
        <Swiper
          breakpoints={{
            340: {
              slidesPerView: 1,
            ...
            <SwiperSlide key={item.title}>
              ...
              >
                ...
                <div className="relative flex flex-col gap-3">
                  <h1 className="text-xl lg:text-2xl text-black group-hover:text-white">
                    {item.title}{" "}
                  </h1>
                  <p className="text-[10px] lg:text-[18px] text-white opacity-0 group-hover:opacity-100">
                    {item.content}{" "}
                  </p>
                </div>
